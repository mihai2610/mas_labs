...
class MyAgent(BlocksWorldAgent):
    ...
    def response(self, perception: BlocksWorldPerception):
        ...
        for el in perception.visible_stacks:
            print(el)
        print("current_station", perception.current_station)
        print("previous_action_succeeded", perception.previous_action_succeeded)
